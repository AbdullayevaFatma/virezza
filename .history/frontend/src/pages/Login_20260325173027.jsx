    ...
    <div className="flex">
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center p-8 md:p-12">
        <form
          ...
          className="w-full max-w-md mb-white p-8 rounded-lg border border-gray-200 shadow-sm"
        >
          ...
          <p className="mt-6 text-center text-sm">
            ...
            <Link to={`/register?redirect=${encodeURIComponent}`}className="text-blue-500">
              Register
            </Link>
          </p>
        </form>
