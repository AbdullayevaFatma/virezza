  ...
  return (
    ...
    <nav className='container mx-auto flex items-center justify-between py-4 px-6'>
      ...
      <div className='hidden md:flex space-x-6'>
        <Link className='text-gray-700 hover:text-black text-sm font-medium uppercase' to="collections/all">Men</Link>
      ...
      <div className='flex items-center space-x-4'>
        <Link to="/admin" className='block bg-black px-2 text-sm text-white'>Admin</Link>
