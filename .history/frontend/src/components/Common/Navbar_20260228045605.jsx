...
import { HiOutlineUser, HiOutlineShoppingBag, HiOutlineArrowSmRight } from "react-icons/hi2"
    ...
    <nav className='container mx-auto flex items-center justify-between py-4 px-6'>
      ...
      <div className='flex items-center space-x-4'>
        ...
        <button className='relative hover:text-black'>
          ...
          <span className='absolute bg-orange-50 text-white text-xs rounded-full px-2 py-0.5'>4</span>
        </button>
      </div>
    </nav>
  )
