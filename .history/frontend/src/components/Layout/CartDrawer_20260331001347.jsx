    ...
    >
      <div className="flex justify-end p-4">
        <button onClick={toggleCartDrawer}>
          <IoMdClose className=" h-6 w-6 text-gray-700 hover:text-black transition-colors duration-300 cursor-pointer" />
        </button>
      </div>
      {/* Cart Content */}
      ...
      <div className="p-4 bg-white sticky bottom-0">
        {
          cart && cart?.products?.length > 0 && (
            <>
             <button onClick={handleCheckout} className="w-full bg-black hover:bg-gray-800 text-white py-3 text-sm  font-light transition-colors duration-300 cursor-pointer">Proceed to checkout</button>
