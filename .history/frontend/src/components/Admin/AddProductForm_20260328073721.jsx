...
const handleSubmit = async (e) => {
  ...
  productData.images.forEach((file) => {
    formData.append("images", file); // dosyaları ekliyoruz
  });

  try {
    // Redux dispatch yerine doğrudan axios ile gönderiyoruz
    const { data } = await axios.post(
      `${proccess.meta.env.VITE_BACKEND_URL}/api/admin/products`,
      formData,
      {
    ...
    setProductData(initialState); // formu resetle
  } catch (error) {
