...
const AddProductForm = () => {
  ...
  const handleImageChange = (e) => {
    ...
    setProductData({ ...productData, images: imagesWithPreview });
  };
  ...
  const handleSubmit = (e) => {
    ...
    formData.append("weight", Number(productData.weight));
    formData.append("dimensions[length]", Number(productData.dimensions.length));
    formData.append("dimensions[width]", Number(productData.dimensions.width));
    formData.append("dimensions[height]", Number(productData.dimensions.height));
