    ...
    <div className="bg-white rounded-lg p-6">
      ...
      <form >
        ...
        <div className="mb-4 ">
          ...
          <input type="text" className="w-full p-2 border rounded" value={shippingAddress.address} onChange={(e)=>setShippingAddress({...shippingAddress,address:e.target.value})}/>
        </div>
      </form>
    </div>
  </div>;
