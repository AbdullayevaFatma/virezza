      ...
      <form >
        ...
        <div className="mb-4 grid grid-cols-2 gap-4">
          <div>
            ...
            <input type="text"  className="w-full p-2 border rounded" required value={shippingAddress.firstName} onChange={(e)=>setShippingAddress({...shippingAddress,firstName:e.target.va})}/>
          </div>
        </div>
      </form>
    </div>
