  ...
  >
    <div className="flex items-start">
      ...
      <div>
        ...
        <p className="text-sm text-gray-500 font-light">Size: {product.size}</p>
        <p className="text-sm text-gray-500 font-light">Color: {product.color}</p>
        <div className="flex items-center mt-2 border justify-between">
