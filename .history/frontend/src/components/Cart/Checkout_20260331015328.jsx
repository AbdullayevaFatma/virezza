  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-7xl mx-auto py-10 px-6 tracking-tighter">
        ...
        <form onSubmit={handleCreateCheckout}>
          ...
          <div className="mb-4">
            ...
            <input
              ...
              className="w-full p-2 borde rborder-gray-400"
              disabled
            />
          </div>
      ...
      <div className="bg-mist-50 p-6">
        ...
        <div className="border-t border-gray-200 py-4 mb-4 ">
          {cart.products.map((product, index) => (
            ...
            >
              ...
              <p className="text-lg font-light">${(product.price * product.quantity)?.toLocaleString()}</p>
            </div>
          ))}
        </div>
        <div className="flex justify-between items-center text-lg font-light mb-4">
          <p>Subtotal</p>
        ...
        <div className="flex justify-between items-center text-lg mt-4 border-t border-gray-200 pt-4 font-light">
          <p>Total</p>
          <p>${cart.totalPrice?.toLocaleString()}</p>
        </div>
      </div>
