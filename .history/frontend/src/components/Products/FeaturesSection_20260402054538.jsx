    ...
    <section className="py-16 px-4 bg-white">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
        ...
        <div className="flex flex-col items-center">
          ...
          <p className="text-gray-500 text-sm font-light tracking-tighter max-w-xs text-center">Curated selection of 200+ global luxury brands</p>
        </div>
        <div className="flex flex-col items-center">
          <div className="p-4 rounded-full mb-4">
          ...
          <p className="text-gray-500 text-sm font-light tracking-tighter max-w-xs text-center">Limited-edition collections you won’t see elsewhere</p>
        </div>
        <div className="flex flex-col items-center">
          <div className="p-4 rounded-full mb-4">
          ...
          <p className="text-gray-500 text-sm font-light tracking-tighter max-w-xs text-center">Worldwide delivery to 130+ destinations</p>
        </div>
      </div>
    </section>
  )
