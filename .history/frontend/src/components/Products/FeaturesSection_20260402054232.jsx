    ...
    <section className="py-16 px-4 bg-white">
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
        ...
        <div className="flex flex-col items-center">
          ...
          <h4 className="tracking-tighter mb-2 uppercase">Top Designers</h4>
        ...
        <div className="flex flex-col items-center">
          ...
          <h4 className="tracking-tighter mb-2 uppercase">Quick & Reliable Delivery</h4>
          <p className="text-gray-600 text-sm tracking-tighter">Worldwide delivery to 130+ destinations</p>
        </div>
      </div>
    </section>
  )
