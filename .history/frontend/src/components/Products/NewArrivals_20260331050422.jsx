...
const NewArrivals = () => {
  ...
  const scroll = (direction) => {
    ...
    const cardWidth = card.offsetWidth + 16; // gap dahil
  ...
  return (
    <section className="py-20 bg-white">
      ...
      <div className="flex items-start w-full">
        ...
        <div
          ref={scrollRef}
          className="flex gap-4 overflow-x-scroll flex-1 py-8 px-4  scroll-smooth"
          style={{
            scrollbarWidth: "none",
