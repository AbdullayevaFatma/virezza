  ...
  return <div className="p-4">
    ...
    <div className="mb-6">
      ...
      <div className="flex flex-wrap gap-2">
          {
        colors.map((color)=>(
         <button value={category} onChange={handleFilterChange}  key={color} name="color" className="w-8 h-8 rounded-full cursor-pointer transition hover:scale-105" style={{backgroundColor: color.toLowerCase()}}></button>
        ))
      }
      </div>
